...
<head>
    ...
    <title>Mood Tracker Management System</title>
</head>
<body>
<header>
      <nav class="header__nav">
        <div class="header__logo">
        <a href="index.php"><h4 data-aos="fade-down">Mood Tracker Management System</h4></a>
        ...
        <ul class="header__menu" data-aos="fade-down">
          ...
          <li>
            <a href="admin-journal.php">Journals</a>
          </li>
          <li>
