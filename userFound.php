...
<table>
   ...
   <?php
	...
	//make the query
	$q= "SELECT userID, fullname, userPassword, userEmail, username FROM user WHERE
		fullname='$in' ORDER BY userID";
    ...
    ?>
      ...
      <tr>
        <td><?php echo $row['userID']; ?></td>
         ...
         <td>
         <a href="users.php?back=<?php echo $row['userID']; ?>" class="option-btn"> Back </a>
      </tr>
